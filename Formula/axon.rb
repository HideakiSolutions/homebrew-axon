class Axon < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/HideakiSolutions/axon/releases/download/v0.5.5/axon-0.5.5-macos-arm64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/HideakiSolutions/axon/releases/download/v0.5.5/axon-0.5.5-linux-x64.tar.gz"
